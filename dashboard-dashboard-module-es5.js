...
var DtTrackComponent = /** @class */ (function () {
    function DtTrackComponent(topicService, route, loadingService) {
    ...
    DtTrackComponent.prototype.ngOnInit = function () {
        ...
        this.state$ = this.route.paramMap
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return window.history.state; })).subscribe(function (topic) {
            if (Object.keys(topic).length == 1) {
                _this.fetchTopicFromDb();
            }
            else {
                _this.detailedTopic = _this.toDetailedTopic(topic);
                _this.dbTopic = topic;
    ...
    DtTrackComponent.prototype.toDetailedTopic = function (dbTopic) {
        var lastIteration = dbTopic.data.iterations[dbTopic.data.iterations.length - 1];
        return {
    ...
    DtTrackComponent.prototype.getStage = function (dbTopic, index) {
        var lastIteration = dbTopic.data.iterations[dbTopic.data.iterations.length - 1];
        var stage = lastIteration.stages[index];
        return {
            level: index,
    ...
    DtTrackComponent.prototype.fetchTopicFromDb = function () {
        var _this = this;
        this.routeId$ = this.route.params.subscribe(function (params) {
            var topicId = params['id'];
            _this.topicService.getTopicById(topicId).subscribe(function (topic) {
                _this.detailedTopic = _this.toDetailedTopic(topic);
                _this.dbTopic = topic;
                _this.stage = _this.detailedTopic.current_stage;
            });
...
var WhiteboardComponent = /** @class */ (function () {
    function WhiteboardComponent(scriptLoader, loadingService) {
        this.scriptLoader = scriptLoader;
        this.loadingService = loadingService;
    }
    WhiteboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.scriptLoader.load('whiteboard').then(function (data) {
            ...
            $.ajax({
                ...
                // remove logo
                $('.logo__box').empty();
                _this.scriptLoader.load('whiteboard_toolbar').then(function (data) {
                    initToolbar();
    ...
    WhiteboardComponent.prototype.ngOnDestroy = function () {
        delete window['aww'];
    };
    WhiteboardComponent.ctorParameters = function () { return [
...
var TopicComponent = /** @class */ (function () {
    ...
    TopicComponent.prototype.redirect = function () {
        this.topic.data.members = this.topic.data.members.map(function (docRef) { return docRef.id; });
        this.router.navigateByUrl('dashboard/topic/' + this.simpleTopic.topic_id, { state: this.topic });
    };
    TopicComponent.prototype.toTopic = function (dbTopic) {
        var lastIteration = dbTopic.data.iterations[dbTopic.data.iterations.length - 1];
...
var TopicsListComponent = /** @class */ (function () {
    function TopicsListComponent(topicService, loadingService) {
        this.topicService = topicService;
        this.loadingService = loadingService;
        this.topics = [];
    }
    TopicsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loadingService.setLoading(true);
        this.topicService.getTopicsByUser().subscribe(function (dbTopic) {
            _this.topics.push(dbTopic);
            _this.loadingService.setLoading(false);
        });
    };
    TopicsListComponent.prototype.getTotalMembers = function () {
        return this.topics.reduce(function (sum, currentTopic) { return sum + currentTopic.data.members.length; }, 0);
    };
    TopicsListComponent.ctorParameters = function () { return [
...
var UserSidebarComponent = /** @class */ (function () {
    function UserSidebarComponent(screenDimService) {
        this.screenDimService = screenDimService;
        this.minHeight = 30000;
    }
    UserSidebarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.screenDimService.minHeight.subscribe(function (height) {
            _this.minHeight = Math.min(height, _this.minHeight);
        });
        this.screenDimService.contentHeight.subscribe(function (height) {
            _this.minHeight = Math.min(height, _this.minHeight);
        });
    };
    UserSidebarComponent.ctorParameters = function () { return [
