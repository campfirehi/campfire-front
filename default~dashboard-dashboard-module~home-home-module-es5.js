(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~dashboard-dashboard-module~home-home-module"],{
...
/***/ "./src/app/utility/services/scripts-loader/script-loading.service.ts":
/*!***************************************************************************!*\
  !*** ./src/app/utility/services/scripts-loader/script-loading.service.ts ***!
  \***************************************************************************/
...
/* harmony import */ var _script_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./script-store */ "./src/app/utility/services/scripts-loader/script-store.ts");



var ScriptLoadingService = /** @class */ (function () {
    function ScriptLoadingService() {
        var _this = this;
        this.scripts = {};
    ...
    ScriptLoadingService.prototype.load = function () {
        var _this = this;
        var scripts = [];
        for (var _i = 0; _i < arguments.length; _i++) {
    ...
    ScriptLoadingService.prototype.loadScript = function (name) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    ScriptLoadingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        })
    ], ScriptLoadingService);
    return ScriptLoadingService;
}());
...
/***/ "./src/app/utility/services/scripts-loader/script-store.ts":
/*!*****************************************************************!*\
  !*** ./src/app/utility/services/scripts-loader/script-store.ts ***!
  \*****************************************************************/
...
/***/ "./src/app/utility/services/topics/topic.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/utility/services/topics/topic.service.ts ***!
  \**********************************************************/
...
/* harmony import */ var _auth_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../auth/auth-guard */ "./src/app/utility/services/auth/auth-guard.ts");
...
var TopicService = /** @class */ (function () {
    function TopicService(afs, authGuard) {
        this.afs = afs;
        this.authGuard = authGuard;
    }
    TopicService_1 = TopicService;
    TopicService.prototype.joinTopic = function (topic) {
        var uid = this.authGuard.getUserUID();
        if (uid) {
            var userDoc_1 = this.afs.collection('users').doc(uid);
            var topicRef_1 = this.afs.collection('topics').doc(topic.id).ref;
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(userDoc_1.update({
                topics: firebase__WEBPACK_IMPORTED_MODULE_3__["firestore"].FieldValue.arrayUnion(topicRef_1)
            })
                .then(function () {
                topicRef_1.update({
                    members: firebase__WEBPACK_IMPORTED_MODULE_3__["firestore"].FieldValue.arrayUnion(userDoc_1.ref)
                })
                    .then(function () {
    ...
    TopicService.prototype.getAllTopics = function () {
        return this.afs.collection('topics').get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (snapshot) {
            var topics = [];
            snapshot.docs.forEach(function (doc) {
                var topic = doc.data();
                topics.push(TopicService_1.toDbTopic(doc.id, topic));
            });
            return topics;
        }));
    };
    TopicService.prototype.getTopicsByUser = function () {
        var userUid = this.authGuard.getUserUID();
        if (userUid) {
            return this.afs.collection('users').doc(userUid).get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (snapshot) {
                var topicRefs = snapshot.data().topics;
                return topicRefs.map(function (ref) { return Object(_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["fromDocRef"])(ref); });
            })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (obs) { return obs.map(function (newObs) { return newObs.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (snashot) {
                return TopicService_1.toDbTopic(snashot.payload.id, snashot.payload.data());
            })); }); }))
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (response) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"])(response); }));
        }
        else {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["empty"])().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (_) { return []; }));
        }
        /*
    ...
    TopicService.prototype.getTopicById = function (topicId) {
        return this.afs.collection('topics').doc(topicId).get().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (snapshot) {
            return TopicService_1.toDbTopic(snapshot.id, snapshot.data());
        }));
    };
    TopicService.toDbTopic = function (id, topic) {
        return {
            id: id,
            data: {
                topic: topic.topic,
    ...
    TopicService.convertStageIndexToName = function (index) {
        return ['Empathize', 'Define', 'Ideate', 'Prototype', 'Test'][index];
    };
    var TopicService_1;
    TopicService.ctorParameters = function () { return [
        { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] },
        { type: _auth_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuardService"] }
    ]; };
    TopicService = TopicService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        })
    ], TopicService);
...
//# sourceMappingURL=default~dashboard-dashboard-module~home-home-module-es5.js.map